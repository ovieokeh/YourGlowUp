...
import { Dimensions, FlatList, Image, Pressable, SafeAreaView, StyleSheet, View } from "react-native";
...
export default function LogsScreen() {
  ...
  const initialTab = params.activeTab === "Exercise%Logs" ? "Exercise Logs" : "Self Reports";
